...
1. Kubespray вместо k3s: тот же контур, но обычный kubeadm-кластер.
2. Выкат через GitOps из репозитория внутри периметра.
3. Ansible вместо скриптов установки.
