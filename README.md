...
1. Ansible вместо скриптов установки: сейчас установка хранилища, времени и
   реестра живёт в bash, а на площадке такое ведут ролями.
2. Сетевые политики внутри кластера: поды пока видят друг друга целиком.
3. Третий голос для пары хранилища, чтобы разрыв связи между машинами
