...
1. Приёмник телеметрии на **EGTS** вместо своего формата: это тот протокол, на
   котором говорят бортовые терминалы техники в России, с буферизацией на борту
   и досылкой после потери связи.
2. Ansible вместо скриптов установки, алерты, резервная копия журнала с
   проверкой восстановления.
3. Сетевые политики внутри кластера и второй управляющий узел.
